...
export default function TabProfileQuiz() {
  const classes = useStyles();
  ...
  useEffect(() => {
    ...
    ProfileService.ProfileQuizFilters().then(
      (res) => {
        setFilter(res.data.options);
        setValue(res.data.options[0].id);
